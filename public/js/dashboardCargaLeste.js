...
function roubosMesCargaLeste() {
    fetch(`/dashboardCargaRouter/roubosMesCargaLeste`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
    }).then(function (resposta) {
      console.log("ESTOU NO THEN DO roubosMesCargaLeste()!")
...
function roubosAnoCargaLeste() {
    fetch(`/dashboardCargaRouter/roubosAnoCargaLeste`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
    }).then(function (resposta) {
      console.log("ESTOU NO THEN DO roubosAnoCargaLeste()!")
...
function graficoLeste() {
  fetch(`/dashboardCargaRouter/graficoLeste`, {
      method: "GET",
      headers: {
          "Content-Type": "application/json"
      }
  }).then(function (resposta) {
      console.log("ESTOU NO THEN DO graficoLeste()!");
      if (resposta.ok) {
          resposta.json().then((json) => {
