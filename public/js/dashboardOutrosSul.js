...
function roubosMesOutrosSul() {
    fetch(`/dashboardRouter/roubosMesOutrosSul`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
    }).then(function (resposta) {
      console.log("ESTOU NO THEN DO roubosMesOutrosSul()!")
...
function roubosAnoOutrosSul() {
    fetch(`/dashboardRouter/roubosAnoOutrosSul`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
    }).then(function (resposta) {
      console.log("ESTOU NO THEN DO roubosAnoOutrosSul()!")
...
function graficoOutrosSul() {
  fetch(`/dashboardRouter/graficoOutrosSul`, {
      method: "GET",
      headers: {
          "Content-Type": "application/json"
      }
  }).then(function (resposta) {
      console.log("ESTOU NO THEN DO graficoOutrosSul()!");
      if (resposta.ok) {
          resposta.json().then((json) => {
