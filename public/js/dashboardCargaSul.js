...
function roubosMesCargaSul() {
    fetch(`/dashboardCargaRouter/roubosMesCargaSul`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
    }).then(function (resposta) {
      console.log("ESTOU NO THEN DO roubosMesCargaSul()!")
...
function roubosAnoCargaSul() {
    fetch(`/dashboardCargaRouter/roubosAnoCargaSul`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
    }).then(function (resposta) {
      console.log("ESTOU NO THEN DO roubosAnoCargaSul()!")
...
function graficoSul() {
  fetch(`/dashboardCargaRouter/graficoSul`, {
      method: "GET",
      headers: {
          "Content-Type": "application/json"
      }
  }).then(function (resposta) {
      console.log("ESTOU NO THEN DO graficoSul()!");
      if (resposta.ok) {
          resposta.json().then((json) => {
