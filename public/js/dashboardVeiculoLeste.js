...
function roubosMesVeiculoLeste() {
    fetch(`/dashboardVeiculoRouter/roubosMesVeiculoLeste`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
    }).then(function (resposta) {
      console.log("ESTOU NO THEN DO roubosMesVeiculoLeste()!")
...
function roubosAnoVeiculoLeste() {
    fetch(`/dashboardVeiculoRouter/roubosAnoVeiculoLeste`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
    }).then(function (resposta) {
      console.log("ESTOU NO THEN DO roubosAnoVeiculoLeste()!")
...
function graficoVeiculoLeste() {
  fetch(`/dashboardVeiculoRouter/graficoVeiculoLeste`, {
      method: "GET",
      headers: {
          "Content-Type": "application/json"
      }
  }).then(function (resposta) {
      console.log("ESTOU NO THEN DO graficoVeiculoLeste()!");
      if (resposta.ok) {
          resposta.json().then((json) => {
