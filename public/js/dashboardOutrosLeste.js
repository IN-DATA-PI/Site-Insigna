...
function roubosMesOutrosLeste() {
    fetch(`/dashboardRouter/roubosMesOutrosLeste`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
    }).then(function (resposta) {
      console.log("ESTOU NO THEN DO roubosMesOutrosLeste()!")
...
function roubosAnoOutrosLeste() {
    fetch(`/dashboardRouter/roubosAnoOutrosLeste`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json"
      }
    }).then(function (resposta) {
      console.log("ESTOU NO THEN DO roubosAnoOutrosLeste()!")
...
function graficoOutrosLeste() {
  fetch(`/dashboardRouter/graficoOutrosLeste`, {
      method: "GET",
      headers: {
          "Content-Type": "application/json"
      }
  }).then(function (resposta) {
      console.log("ESTOU NO THEN DO graficoOutrosLeste()!");
      if (resposta.ok) {
          resposta.json().then((json) => {
